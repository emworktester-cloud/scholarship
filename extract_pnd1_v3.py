...
def extract_pdfs_for_year(folder_path, output_excel, reader):
    ...
    with pd.ExcelWriter(output_excel, engine="xlsxwriter") as writer:
        for pdf_path in pdf_files:
            ...
            try:
                ...
                for page_num in range(1, len(doc)): # Start from page 2
                    page = doc[page_num]
                    # Use lower DPI for better CPU performance without losing logic precision
...
if __name__ == "__main__":
    print("Loading EasyOCR model for Thai/English...")
    reader = easyocr.Reader(['th', 'en'])
    print("Model loaded. Starting extraction...")
    extract_pdfs_for_year(r"C:\Users\USER\Downloads\2567 ภ.ง.ด.1", r"C:\Users\USER\Downloads\PND1_2567_Result.xlsx", reader)
    extract_pdfs_for_year(r"C:\Users\USER\Downloads\2568 ภ.ง.ด.1", r"C:\Users\USER\Downloads\PND1_2568_Result.xlsx", reader)
