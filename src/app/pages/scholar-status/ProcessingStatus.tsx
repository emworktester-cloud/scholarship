...
const processingRecords: ProcessingRecord[] = [
  { id: 'PRC-001', type: 'ขอขยายระยะเวลาศึกษา', scholarName: 'นายธนกฤต ประสบผล', scholarId: 'SCH-2568-010', statusNo: 3, statusName: 'อยู่ระหว่างดำเนินการ', description: 'ขอขยายเวลา 1 ภาคเรียน เพื่อแก้ไขวิทยานิพนธ์', submittedDate: '15 ก.พ. 2569', lastUpdated: '20 ก.พ. 2569', handler: 'สนร. วอชิงตัน' },
  { id: 'PRC-002', type: 'ขออนุมัติไปร่วมประชุมวิชาการ', scholarName: 'น.ส.พรพิมล สุขใจ', scholarId: 'SCH-2569-001', statusNo: 5, statusName: 'อนุมัติ/อนุญาต/รับทราบ', description: 'ร่วม IEEE Conference ที่ San Francisco', submittedDate: '10 ก.พ. 2569', lastUpdated: '18 ก.พ. 2569', handler: 'เจ้าหน้าที่ ก.พ.' },
  { id: 'PRC-003', type: 'ขอเปลี่ยนสาขาวิชา', scholarName: 'น.ส.ปิยะดา เก่งกล้า', scholarId: 'SCH-2568-042', statusNo: 4, statusName: 'ขอเอกสารเพิ่มเติม', description: 'เปลี่ยนจาก Applied Physics เป็น Quantum Computing', submittedDate: '8 ก.พ. 2569', lastUpdated: '22 ก.พ. 2569', handler: 'สนร. โตเกียว' },
  { id: 'PRC-004', type: 'ขอกลับเยี่ยมบ้านชั่วคราว', scholarName: 'นายวิชัย สมบูรณ์', scholarId: 'SCH-2569-002', statusNo: 1, statusName: 'ยังไม่ได้ส่ง', description: 'ขอกลับเยี่ยมบ้านช่วงปิดเทอม Summer 2569', submittedDate: '-', lastUpdated: '25 ก.พ. 2569', handler: '-' },
  { id: 'PRC-005', type: 'ขอย้ายสถานศึกษา', scholarName: 'นายภูมิพัฒน์ ดีเลิศ', scholarId: 'SCH-2569-010', statusNo: 6, statusName: 'ไม่อนุมัติ/ไม่อนุญาต', description: 'ย้ายจาก Oxford ไป Cambridge — ไม่อนุมัติเนื่องจากไม่ตรงสาขา', submittedDate: '1 ก.พ. 2569', lastUpdated: '15 ก.พ. 2569', handler: 'เจ้าหน้าที่ ก.พ.' },
  { id: 'PRC-006', type: 'รายงานผลการศึกษา', scholarName: 'น.ส.อรุณี ก้าวหน้า', scholarId: 'SCH-2567-005', statusNo: 7, statusName: 'ส่งกลับให้แก้ไข', description: 'Transcript ไม่ชัดเจน — ขอส่งใหม่', submittedDate: '12 ก.พ. 2569', lastUpdated: '19 ก.พ. 2569', handler: 'สนร. ลอนดอน' },
  { id: 'PRC-007', type: 'ขอยุติการศึกษา', scholarName: 'นายสุรเดช แข็งแกร่ง', scholarId: 'SCH-2568-030', statusNo: 8, statusName: 'แจ้งแก้ไข/ลบ/ยกเลิก', description: 'ขอยกเลิกคำขอยุติการศึกษา — จะศึกษาต่อ', submittedDate: '5 ก.พ. 2569', lastUpdated: '23 ก.พ. 2569', handler: 'สนร. ลอนดอน' },
  { id: 'PRC-008', type: 'ขอพักการศึกษาชั่วคราว', scholarName: 'นายธนกฤต ประสบผล', scholarId: 'SCH-2568-010', statusNo: 9, statusName: 'ยอมรับการแก้ไข/ลบ/ยกเลิก', description: 'ยอมรับการแก้ไขระยะเวลาพัก — จาก 1 เทอม เป็น 2 เทอม', submittedDate: '20 ม.ค. 2569', lastUpdated: '24 ก.พ. 2569', handler: 'เจ้าหน้าที่ ศกศ.' },
];
