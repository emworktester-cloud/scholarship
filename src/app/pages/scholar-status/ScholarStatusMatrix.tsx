...
const statusRecords: ScholarStatusRecord[] = [
  { id: 'SR-001', scholarId: 'SCH-2569-001', scholarName: 'น.ส.พรพิมล สุขใจ', statusNo: 1, statusName: 'สถานะการรับทุน', subStatus: 'ยืนยันรับทุน', phase: 'ก่อนเดินทาง', effectiveDate: '1 ม.ค. 2569', notes: 'ยืนยันรับทุน ก.พ. ปี 2569', updatedBy: 'เจ้าหน้าที่ ศกศ.', updatedDate: '5 ม.ค. 2569' },
  { id: 'SR-002', scholarId: 'SCH-2568-010', scholarName: 'นายธนกฤต ประสบผล', statusNo: 4, statusName: 'พักการศึกษาชั่วคราว', subStatus: 'พักเพื่อรักษาตัว', phase: 'ระหว่างศึกษา', effectiveDate: '15 ก.พ. 2569', notes: 'พักการศึกษา 1 ภาคเรียน เพื่อรักษาสุขภาพจิต', updatedBy: 'สนร. วอชิงตัน', updatedDate: '15 ก.พ. 2569' },
  { id: 'SR-003', scholarId: 'SCH-2567-005', scholarName: 'น.ส.อรุณี ก้าวหน้า', statusNo: 5, statusName: 'สำเร็จการศึกษา', subStatus: 'บรรจุเข้าทำงาน', phase: 'สำเร็จ/เสร็จสิ้น', effectiveDate: '30 ก.ย. 2568', notes: 'สำเร็จ M.Sc. Data Science ส่งตัวเข้ารับราชการ', updatedBy: 'เจ้าหน้าที่ ก.พ.', updatedDate: '20 ต.ค. 2568' },
  { id: 'SR-004', scholarId: 'SCH-2568-030', scholarName: 'นายสุรเดช แข็งแกร่ง', statusNo: 3, statusName: 'ขาดการติดต่อ', subStatus: 'ขาดการติดต่อ > 3 เดือน', phase: 'ระหว่างศึกษา', effectiveDate: '1 ธ.ค. 2568', notes: 'ไม่สามารถติดต่อได้ตั้งแต่ ธ.ค. 2568 — สนร. กำลังติดตาม', updatedBy: 'สนร. ลอนดอน', updatedDate: '10 ก.พ. 2569' },
  { id: 'SR-005', scholarId: 'SCH-2566-015', scholarName: 'นายวิวัฒน์ พัฒนา', statusNo: 11, statusName: 'อยู่ระหว่างฟ้องร้องบังคับคดี', subStatus: 'ผิดสัญญาชดใช้ทุน', phase: 'ระหว่างศึกษา', effectiveDate: '20 ม.ค. 2569', notes: 'ไม่กลับมาชดใช้ทุนตามสัญญา — อัยการยื่นฟ้อง', updatedBy: 'ฝ่ายกฎหมาย ก.พ.', updatedDate: '20 ม.ค. 2569' },
  { id: 'SR-006', scholarId: 'SCH-2568-042', scholarName: 'น.ส.ปิยะดา เก่งกล้า', statusNo: 8, statusName: 'ผ่อนผันการเดินทางกลับไทย', subStatus: 'ผ่อนผัน 3 เดือน', phase: 'ระหว่างศึกษา', effectiveDate: '1 มี.ค. 2569', notes: 'ขอผ่อนผันเดินทางกลับ เพื่อรอผลวิทยานิพนธ์', updatedBy: 'สนร. โตเกียว', updatedDate: '25 ก.พ. 2569' },
];
