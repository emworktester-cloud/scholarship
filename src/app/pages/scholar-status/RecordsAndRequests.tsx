...
const actionRecords: ActionRecord[] = [
  { id: 'ACT-001', type: 'รับทราบ', actionType: 'acknowledge', scholarName: 'น.ส.พรพิมล สุขใจ', scholarId: 'SCH-2569-001', requestTitle: 'รายงานผลการศึกษา Fall 2568', requestDate: '10 ก.พ. 2569', actionDate: '18 ก.พ. 2569', actionBy: 'นายประสิทธิ์ ผู้ดูแล', actionByRole: 'ผอ.ศกศ.', notes: 'GPA 3.85 — รับทราบผลการศึกษาปกติ', status: 'completed' },
  { id: 'ACT-002', type: 'อนุญาต', actionType: 'permit', scholarName: 'น.ส.พรพิมล สุขใจ', scholarId: 'SCH-2569-001', requestTitle: 'ขอไปร่วม IEEE Conference', requestDate: '10 ก.พ. 2569', actionDate: '18 ก.พ. 2569', actionBy: 'นายประสิทธิ์ ผู้ดูแล', actionByRole: 'ผอ.ศกศ.', notes: 'อนุญาตให้เข้าร่วมตามที่เสนอ', status: 'completed' },
  { id: 'ACT-003', type: 'อนุมัติ', actionType: 'approve', scholarName: 'นายธนกฤต ประสบผล', scholarId: 'SCH-2568-010', requestTitle: 'ขอขยายระยะเวลาศึกษา 1 ภาคเรียน', requestDate: '15 ก.พ. 2569', actionDate: '-', actionBy: '-', actionByRole: '-', notes: 'รอพิจารณาจาก ผอ.ศกศ.', status: 'pending' },
  { id: 'ACT-004', type: 'อนุญาต', actionType: 'permit', scholarName: 'นายวิชัย สมบูรณ์', scholarId: 'SCH-2569-002', requestTitle: 'ขอกลับเยี่ยมบ้านชั่วคราว', requestDate: '20 ก.พ. 2569', actionDate: '-', actionBy: '-', actionByRole: '-', notes: 'รอพิจารณา — ส่งผ่าน สนร. ลอนดอน', status: 'pending' },
  { id: 'ACT-005', type: 'อนุมัติ', actionType: 'approve', scholarName: 'น.ส.ปิยะดา เก่งกล้า', scholarId: 'SCH-2568-042', requestTitle: 'ขอเปลี่ยนสาขาวิชา', requestDate: '8 ก.พ. 2569', actionDate: '-', actionBy: '-', actionByRole: '-', notes: 'ขอเอกสารเพิ่มเติม — หนังสือรับรองจากสถานศึกษา', status: 'pending' },
  { id: 'ACT-006', type: 'รับทราบ', actionType: 'acknowledge', scholarName: 'น.ส.มณีรัตน์ รุ่งเรือง', scholarId: 'SCH-2568-022', requestTitle: 'แจ้งที่อยู่ปัจจุบันในต่างประเทศ', requestDate: '22 ก.พ. 2569', actionDate: '23 ก.พ. 2569', actionBy: 'เจ้าหน้าที่ สนร.', actionByRole: 'เจ้าหน้าที่', notes: 'รับทราบที่อยู่ใหม่', status: 'completed' },
];
