...
const auditLogs: AuditLog[] = [
  { id: 'RA-001', user: 'นายประสิทธิ์ ผู้ดูแล', role: 'ADMIN', action: 'export', reportName: 'รายงานภาพรวมทุน', reportType: 'overview', format: 'PDF', dataScope: 'ทุกปีงบประมาณ', recordCount: 1200, hasPassword: true, hasWatermark: true, reason: 'จัดทำรายงานประจำปีเสนอผู้บริหาร', ip: '192.168.1.100', device: 'Chrome / Windows', time: '24/02/2569 15:30', risk: 'low' },
  { id: 'RA-002', user: 'นางสาวพิมพ์พร เจ้าหน้าที่', role: 'STAFF', action: 'export', reportName: 'รายงานสถานะใบสมัคร', reportType: 'application', format: 'Excel', dataScope: 'ปี 2569', recordCount: 342, hasPassword: true, hasWatermark: true, reason: 'ตรวจสอบสถานะคำขอค้างรอ', ip: '192.168.1.45', device: 'Safari / macOS', time: '24/02/2569 14:15', risk: 'low' },
  { id: 'RA-003', user: 'นายสมศักดิ์ ผู้จัดการ', role: 'MANAGER', action: 'export', reportName: 'รายงานประวัติรายบุคคล', reportType: 'individual', format: 'PDF', dataScope: 'ข้อมูลบุคคล (PII)', recordCount: 1, hasPassword: true, hasWatermark: true, reason: 'ตรวจสอบประวัติเพื่อพิจารณาต่อสัญญา', ip: '192.168.1.50', device: 'Chrome / Windows', time: '24/02/2569 10:45', risk: 'medium' },
  { id: 'RA-004', user: 'นางสาวรัตนา การเงิน', role: 'FINANCE', action: 'export', reportName: 'รายงานการจ่ายเงิน', reportType: 'payment', format: 'Excel', dataScope: 'ปี 2569 Q1', recordCount: 450, hasPassword: true, hasWatermark: true, reason: 'จัดทำรายงานประจำไตรมาส', ip: '192.168.1.92', device: 'Edge / Windows', time: '24/02/2569 09:00', risk: 'low' },
  { id: 'RA-005', user: 'นายสมศักดิ์ ผู้จัดการ', role: 'MANAGER', action: 'export', reportName: 'รายงานข้อมูลนักเรียนทุนทั้งหมด', reportType: 'bulk', format: 'Excel', dataScope: 'ข้อมูลส่วนบุคคลรวม (PII)', recordCount: 1200, hasPassword: false, hasWatermark: true, reason: 'จัดทำสถิติภายใน', ip: '192.168.1.50', device: 'Chrome / Windows', time: '23/02/2569 16:00', risk: 'high' },
  { id: 'RA-006', user: 'ศ.ดร.วิภา นักวิชาการ', role: 'REVIEWER', action: 'view', reportName: 'รายงานติดตามผลการศึกษา', reportType: 'tracking', format: '-', dataScope: 'ปี 2568-2569', recordCount: 680, hasPassword: false, hasWatermark: false, reason: 'ดูข้อมูลเพื่อประกอบการพิจารณา', ip: '10.0.0.55', device: 'Chrome / macOS', time: '23/02/2569 14:30', risk: 'low' },
  { id: 'RA-007', user: 'นายประสิทธิ์ ผู้ดูแล', role: 'ADMIN', action: 'export', reportName: 'รายงานการเข้าถึง (Audit)', reportType: 'audit', format: 'PDF', dataScope: 'เดือน ก.พ. 2569', recordCount: 250, hasPassword: true, hasWatermark: true, reason: 'ตรวจสอบ Compliance ประจำเดือน', ip: '192.168.1.100', device: 'Chrome / Windows', time: '23/02/2569 11:00', risk: 'low' },
  { id: 'RA-008', user: 'นางสาวพิมพ์พร เจ้าหน้าที่', role: 'STAFF', action: 'print', reportName: 'ใบสมัครรายบุคคล', reportType: 'individual', format: 'PDF (Print)', dataScope: 'ข้อมูลบุคคล (PII)', recordCount: 1, hasPassword: false, hasWatermark: true, reason: 'พิมพ์เพื่อจัดเก็บตามระเบียบ', ip: '192.168.1.45', device: 'Safari / macOS', time: '22/02/2569 15:00', risk: 'medium' },
  { id: 'RA-009', user: 'นายวิชัย สมบูรณ์', role: 'EXEC', action: 'view', reportName: 'แดชบอร์ดผู้บริหาร', reportType: 'overview', format: '-', dataScope: 'ภาพรวมทั้งหมด', recordCount: 0, hasPassword: false, hasWatermark: false, reason: 'ดูภาพรวมตัดสินใจ', ip: '192.168.1.1', device: 'Chrome / Windows', time: '22/02/2569 09:30', risk: 'low' },
  { id: 'RA-010', user: 'นางสาวกนกวรรณ นักวิเคราะห์', role: 'STAFF', action: 'export', reportName: 'รายงานวิเคราะห์แนวโน้ม', reportType: 'trend', format: 'Excel', dataScope: '7 ปี (2563-2569)', recordCount: 850, hasPassword: true, hasWatermark: true, reason: 'จัดทำเอกสารนโยบาย', ip: '192.168.1.78', device: 'Firefox / Ubuntu', time: '21/02/2569 10:00', risk: 'low' },
];
