...
const mockScholar: ScholarDetail = {
  ...
  timeline: [
    { date: '15/02/2569', type: 'report', title: 'ส่งรายงานผลการเรียน ภาค 1/2569', detail: 'GPA 3.85 ผ่านการตรวจสอบ', icon: 'education' },
    { date: '10/01/2569', type: 'payment', title: 'เบิกจ่ายค่าเล่าเรียน Term 5', detail: '฿485,000', icon: 'payment' },
    { date: '20/12/2568', type: 'travel', title: 'รายงานเดินทางกลับไทยชั่วคราว', detail: 'เดินทางกลับ 15 ธ.ค. - 5 ม.ค.', icon: 'travel' },
    { date: '01/09/2568', type: 'report', title: 'ส่งรายงานผลการเรียน ภาค 2/2568', detail: 'GPA 3.80 ผ่านการตรวจสอบ', icon: 'education' },
    { date: '15/07/2568', type: 'payment', title: 'เบิกจ่ายค่าครองชีพ Q3/2568', detail: '฿240,000', icon: 'payment' },
    { date: '01/03/2568', type: 'report', title: 'ส่งรายงานผลการเรียน ภาค 1/2568', detail: 'GPA 3.78 ผ่านการตรวจสอบ', icon: 'education' },
    { date: '05/08/2566', type: 'travel', title: 'เดินทางไปศึกษา ณ สหราชอาณาจักร', detail: 'University of Oxford', icon: 'travel' },
    { date: '01/07/2566', type: 'scholarship', title: 'ปฐมนิเทศนักเรียนทุน รุ่น 2566', detail: 'สำนักงาน ก.พ.', icon: 'scholarship' },
    { date: '15/05/2566', type: 'scholarship', title: 'ได้รับอนุมัติทุน ก.พ.', detail: 'ทุนศึกษาต่อ Ph.D. Chemical Engineering', icon: 'scholarship' },
  ],
};
