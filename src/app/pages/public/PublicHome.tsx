...
const newsItems = [
  { id: 1, title: 'ประกาศรับสมัครทุนรัฐบาล ประจำปี 2569 (ทุน ก.พ.)', date: '25 ก.พ. 2569', category: 'ประกาศรับสมัคร', hot: true, desc: 'เปิดรับสมัครแล้ว! ทุน ก.พ. บุคคลทั่วไป ปริญญาโท-เอก จำนวน 120 ทุน สมัครได้ถึง 30 เม.ย. 2569' },
  { id: 2, title: 'ผลการคัดเลือกผู้รับทุนรัฐบาล ปี 2568 รอบสุดท้าย', date: '20 ก.พ. 2569', category: 'ประกาศผล', hot: false, desc: 'ประกาศผลการคัดเลือกรอบสุดท้าย ทุน ก.พ. ปี 2568 จำนวน 95 ราย ตรวจสอบรายชื่อได้ที่นี่' },
  { id: 3, title: 'ปรับปรุงระเบียบการรับทุนรัฐบาล ฉบับใหม่ พ.ศ. 2569', date: '15 ก.พ. 2569', category: 'ระเบียบ/ข้อบังคับ', hot: false, desc: 'ก.พ. ปรับปรุงระเบียบการรับทุน เพิ่มสิทธิประโยชน์ และปรับเงื่อนไขชดใช้ทุนให้สอดคล้องกับสถานการณ์ปัจจุบัน' },
  { id: 4, title: 'กำหนดการปฐมนิเทศนักเรียนทุนรัฐบาล รุ่นที่ 89', date: '10 ก.พ. 2569', category: 'กิจกรรม', hot: false, desc: 'ปฐมนิเทศ นทร. ก่อนเดินทาง วันที่ 15-17 มี.ค. 2569 ณ สำนักงาน ก.พ. จ.นนทบุรี' },
  { id: 5, title: 'สนร. วอชิงตัน จัดงาน Thai Scholars Networking 2569', date: '5 ก.พ. 2569', category: 'กิจกรรม', hot: false, desc: 'เชิญ นทร. ในสหรัฐอเมริกาเข้าร่วมงาน Networking วันที่ 20 มี.ค. 2569 ลงทะเบียนผ่านระบบ' },
  { id: 6, title: 'แนวทางการขอขยายเวลาศึกษา สำหรับ นทร. ที่ได้รับผลกระทบ', date: '1 ก.พ. 2569', category: 'แนวทางปฏิบัติ', hot: false, desc: 'สำนักงาน ก.พ. ผ่อนผันการขอขยายเวลาศึกษาสำหรับ นทร. ที่ได้รับผลกระทบจากสถานการณ์ต่างๆ' },
];
